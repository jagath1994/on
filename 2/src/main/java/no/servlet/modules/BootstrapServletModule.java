...
import no.servlet.config.GenericBootstrapConstants;
import no.shiro.modules.BootstrapShiroModule;
import no.shiro.modules.ShiroAnnotationsModule;
 ...
 * 
 * @see no.rest.SampleSecuredRESTWebService
